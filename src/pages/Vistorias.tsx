...
export default function Vistorias() {
  ...
  return <div className="space-y-6 animate-fade-in">
      ...
      <Link to="/nova-vistoria">
        <Button size="lg" className="w-full md:w-auto bg-gradient-primary hover:opacity-90 transition-opacity shadow-lg gap-3 text-stone-100 bg-violet-900 hover:bg-violet-800 text-center rounded-full font-bold my-[12px] mx-[5px] px-[10px] py-[5px] text-lg">
