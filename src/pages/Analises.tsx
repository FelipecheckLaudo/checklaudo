  ...
  return <div className="space-y-6 animate-fade-in">
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4 items-end">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !dataInicial && "text-muted-foreground")}>
                    ...
                    {dataInicial ? format(dataInicial, "PPP", {
                    locale: ptBR
                  }) : "Selecione a data"}
                  </Button>
                </PopoverTrigger>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !dataFinal && "text-muted-foreground")}>
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {dataFinal ? format(dataFinal, "PPP", {
                    locale: ptBR
                  }) : "Selecione a data"}
                  </Button>
                </PopoverTrigger>
            ...
            <div className="flex gap-2">
              ...
              {(dataInicial || dataFinal) && <Button onClick={limparFiltro} variant="outline">
                  Limpar
                </Button>}
            </div>
          </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            {liberadoresStats.length === 0 ? <div className="text-center py-8 text-muted-foreground">
                ...
                <Table>
                  ...
                  <TableBody>
                    {liberadoresStats.map(stat => <TableRow key={stat.nome}>
        ...
        <Card>
          ...
          <CardContent>
            {digitadoresStats.length === 0 ? <div className="text-center py-8 text-muted-foreground">
                <BarChart3 className="h-12 w-12 mx-auto mb-2 opacity-50" />
                ...
                <Table>
                  ...
                  <TableBody>
                    {digitadoresStats.map(stat => <TableRow key={stat.nome}>
                        <TableCell className="font-medium">{stat.nome}</TableCell>
                        <TableCell className="text-right">{stat.quantidade}</TableCell>
                        <TableCell className="text-right font-semibold">
                          {formatCurrency(stat.valorTotal)}
