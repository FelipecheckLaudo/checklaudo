...
import { ClipboardList, BarChart3, Users, Settings, MessageCircle, LayoutDashboard, Menu } from "lucide-react";
...
const navItems = [
  { path: "/", label: "Vistorias", icon: ClipboardList },
  { path: "/analises", label: "Análises", icon: BarChart3 },
  { path: "/dashboard", label: "Gerenciamento", icon: LayoutDashboard },
...
export default function Layout() {
  ...
  useEffect(() => {
    const handleLogoUpdate = () => {
      setLogoUrl(localStorage.getItem('system_logo') || null);
    };
